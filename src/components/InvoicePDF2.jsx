...
// Function to convert numbers to Arabic words, including decimals خمسون
...
const InvoicePDF = ({ invoice }) => (
  ...
  <Text style={{ textAlign: 'right', fontSize: 14 }}> الوكالة الولائية للتسيير </Text>
      ...
      <View style={styles.table}>
        ...
        <View style={styles.tableRow}>
          <View style={styles.tableCol}><Text style={styles.tableCell}>{invoice.total19} </Text></View>
          <View style={styles.tableCol}><Text style={styles.tableCell}>{invoice.price19}</Text></View>
          <View style={styles.tableCol}><Text style={styles.tableCell}>{invoice.months19}</Text></View>
          <View style={styles.tableCol}><Text style={styles.tableCell}>{invoice.description19}</Text></View>
          <View style={styles.tableCol}><Text style={styles.tableCell}>1</Text></View>
        </View>

        <View style={styles.summaryRow}>
          <View style={styles.summaryCol}><Text style={styles.summaryText}>{invoice.total19}</Text></View>
        ...
        {isValidValue(invoice.clientCountry19) && (
          <View style={styles.summaryRow2}>
            <View style={styles.summaryTotalCol2}><Text style={styles.summaryText}>{invoice.clientCountry19}: المبلغ المسدد 1</Text></View>
          </View>
        )}

        {isValidValue(invoice.clientCity19) && (
          <View style={styles.summaryRow2}>
            <View style={styles.summaryTotalCol2}><Text style={styles.summaryText}>{invoice.clientCity19}: المبلغ المسدد 2</Text></View>
          </View>
        )}

        {isValidValue(invoice.paymentTerms19) && (
          <View style={styles.summaryRow2}>
            <View style={styles.summaryTotalCol2}><Text style={styles.summaryText}>{invoice.paymentTerms19}: المبلغ المسدد 3</Text></View>
          </View>
        )}

        {isValidValue(invoice.Delay19) && (
          <View style={styles.summaryRow2}>
            <View style={styles.summaryTotalCol2}><Text style={styles.summaryText}>{invoice.Delay19}: المبلغ المسدد 4</Text></View>
          </View>
        )}

        {isValidValue(invoice.stampmoney19) && (
          <View style={styles.summaryRow2}>
            <View style={styles.summaryTotalCol2}><Text style={styles.summaryText}>{invoice.stampmoney19}: المبلغ المسدد 5</Text></View>
          </View>
        )}
      ...
      <View style={styles.institutionDetails}>  
      <Text>   أوقفت الفاتورة عند المبلغ :{numberToArabicWords(invoice.FinalP19)}  </Text>
      </View> 
